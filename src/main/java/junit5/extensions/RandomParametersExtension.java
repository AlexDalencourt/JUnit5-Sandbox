 ...
 * <a href="https://github.com/junit-team/junit5/wiki/Third-party-Extensions">https://github.com/junit-team/junit5/wiki/Third-party-Extensions</a>
...
public class RandomParametersExtension implements ParameterResolver {
    ...
    private Object getRandomValue(Parameter parameter, ExtensionContext extensionContext) {
        ...
        java.util.Random random = extensionContext.getRoot().getStore(GLOBAL)//
